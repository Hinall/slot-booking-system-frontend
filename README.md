...
- **Authentication**: login (JWT access token + refresh cookie)
...
![User dashboard — availability and booking link](public/userpage.png)
...
![Booking page](public/bookingpage%20.png)
